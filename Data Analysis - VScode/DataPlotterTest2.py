...
file_path = "C:\\Users\\hroho\\Desktop\\Thrust Vector Control Mount\\StaticFireTest2\\StaticFire2.txt"
...
axis[0].text(1.9,11.7, impulse, fontsize = 10, color = '#FFFFFF')
axis[0].text(0.2,11.7, thrust, fontsize = 10, color = '#FFFFFF')
#ScatterPlot
sc = axis[1].scatter(forceX,forceY, s=15)
